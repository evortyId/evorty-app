...
class HeadTiarasView extends StatefulWidget {
  const HeadTiarasView({super.key});

  @override
  State<HeadTiarasView> createState() => _HeadTiarasViewState();
}

class _HeadTiarasViewState extends State<HeadTiarasView> {
  ...
  List<String> materialAssetList = [
    Assets.iconsIcPearls,
    Assets.iconsIcRubies,
    Assets.iconsIcCrystals,
  ];
        ...
        itemBuilder: (context, index) {
          return InkWell(
            ...
            child: Container(
              ...
              child: Row(
                children: [
                  Image.asset(materialAssetList[index]),
                  Constant.xSizedBox4,
                  Text(
                    materialList[index],
                    style: TextStyle(color: Colors.white, fontSize: 10),
