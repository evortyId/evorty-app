...
class ScarvesView extends StatefulWidget {
  const ScarvesView({super.key});

  @override
  State<ScarvesView> createState() => _ScarvesViewState();
}

class _ScarvesViewState extends State<ScarvesView> {
