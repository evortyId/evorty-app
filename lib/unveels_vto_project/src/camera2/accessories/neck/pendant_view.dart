...
class PendantsView extends StatefulWidget {
  const PendantsView({super.key});

  @override
  State<PendantsView> createState() => _PendantsViewState();
}

class _PendantsViewState extends State<PendantsView> {
