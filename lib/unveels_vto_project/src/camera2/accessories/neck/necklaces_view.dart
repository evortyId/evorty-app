...
class NecklacesView extends StatefulWidget {
  const NecklacesView({super.key});

  @override
  State<NecklacesView> createState() => _NecklacesViewState();
}

class _NecklacesViewState extends State<NecklacesView> {
  ...
  Future<void> fetchData() async {
    ...
    try {
      ...
      List<String>? productTypes =
          getProductTypesByLabels("neck_accessories_product_type", [
        "Necklaces",
      ]);
      print(productTypes);
